...
void AsyncFdWatcher::StopWatchingFileDescriptors(void)
{
    stopThread();
}

AsyncFdWatcher::~AsyncFdWatcher(void)
{
}
...
int AsyncFdWatcher::stopThread(void)
{
...
int AsyncFdWatcher::notifyThread(void)
{
    uint8_t buffer[] = {0};
...
void AsyncFdWatcher::ThreadRoutine(void)
{
    while (running_)
    {
        fd_set read_fds;
